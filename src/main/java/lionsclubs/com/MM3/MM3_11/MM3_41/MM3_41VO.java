...
public class MM3_41VO extends ComDefaultVO implements Serializable{
	...
	private String divisionCode;	/* 예산/실적 구분 코드 : 1000 - 예산, 1010 - 실적 */
	private String classItemCode;	/* 지출예산 분류항목 코드 */
	private String classItemName;	/* 지출예산 분류항목명 */
	private String detailItemCode;	/* 지출예산 세부항목 코드 */
	private String detailItemName;	/* 지출예산 세부항목명 */
