package lionsclubs.com.cmm.excel.jettcustomtag;
 ...
 * </ul>
 */
public class CastIntegerTag extends BaseTag
{
   /**
   ...
   public boolean process()
   {
      ...
      SheetUtil.setCellValue(cell, myValue, getAttributes().get(ATTR_VALUE));
