...
@Controller
public class MM2_06Controller {
	@Resource
	private MM2_06Service service;
	
	@RequestMapping("/MM2/MM2_1/MM2_06/MM2_06.do")
	public String MM2_06(ModelMap model, @ModelAttribute("MM2_06VO") MM2_06VO vo) throws Exception{
		...
		List<MM2_06VO> listVo = service.List(vo);
        model.addAttribute("totalCount", listVo.size());
        model.addAttribute("resultList", listVo);
		model.addAttribute("paymentSum", service.paymentSum(vo));
		
		return "lionsclubs/com/MM2/MM2_1/MM2_06/MM2_06";
	}	
}
