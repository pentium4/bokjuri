package lionsclubs.com.MM2.MM2_1.MM2_10;

import java.util.List;

import javax.annotation.Resource;

import lionsclubs.com.MM2.MM2_1.MM2_09.MM2_09Service;
import lionsclubs.com.MM2.MM2_1.MM2_09.MM2_09VO;
...
@Controller
public class MM2_10Controller {
	@Resource private MM2_09Service sm209Service;
	
	@RequestMapping("/MM2/MM2_1/MM2_10/MM2_10.do")
	public String MM2_09(ModelMap model, @ModelAttribute("MM2_09VO") MM2_09VO vo) throws Exception{
		 ...
		 * 리스트
		 */
		List<MM2_09VO> resultList = sm209Service.List(vo);
        model.addAttribute("resultList", resultList);
        model.addAttribute("totalCount", resultList.size());
		
		return "lionsclubs/com/MM2/MM2_1/MM2_10/MM2_10";
	}	
}
