...
@Repository
public class MM2_27DAO extends LionsAbstractDAO{
	private String commonId = "lionsclubs.com.MM2.MM2_4.MM2_27.";
	 ...
	 * @throws Exception
	 */
	public int deleteData(MM2_27VO_DATA vo) throws Exception {
	...
	public int insertData(MM2_27VO_DATA vo) throws Exception {
	...
	public List<MM2_27VO_DATA> selectList(MM2_24VO_PARAM vo) throws Exception {
		return (List<MM2_27VO_DATA>)list(commonId + "selectList", vo);
	}
	 ...
	 * @throws Exception
	 */
	public int updateData(MM2_27VO_DATA vo) throws Exception {
		return this.update(commonId + "updateData", vo);
	}

	public Integer deleteCopy(MM2_27VO_PARAM vo) throws Exception {
		return delete(commonId + "deleteCopy", vo);
	}
	
	public boolean insertCopy(MM2_27VO_PARAM vo) throws Exception {
