...
public class AttachFileDAO extends EgovComAbstractDAO {
	...
	/**
	 * 파일 아이디로 모든 파일 시퀀스 목록을 조회한다.
	 * @param fileId
	 * @return
	 */
	public Object[] getAttachFileAllSeqs(String fileId) {
		@SuppressWarnings("unchecked")
		List<Object> list = getSqlMapClientTemplate().queryForList("AttachFileDAO.getAttachFileAllSeqs", fileId);
		return list != null ? list.toArray() : null;
	}	
