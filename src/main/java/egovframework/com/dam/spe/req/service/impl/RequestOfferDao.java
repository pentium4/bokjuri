...
public class RequestOfferDao extends EgovComAbstractDAO {
    ...
    public int selectRequestOfferDelCnt(Map map) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferDelCnt", map);
    }
    ...
    public int selectRequestOfferSpeCnt(Map map) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferSpeCnt", map);
    }
    ...
    public List selectRequestOfferList(RequestOfferVO RequestOfferVO) throws Exception {
    	return (List)list("RequestOffer.selectRequestOffer",RequestOfferVO);
    ...
    public int selectRequestOfferListCnt(RequestOfferVO RequestOfferVO) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferCnt", RequestOfferVO);
    }
    ...
    public RequestOfferVO selectRequestOfferDetail(RequestOfferVO RequestOfferVO) throws Exception {
    	return (RequestOfferVO)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferDetail", RequestOfferVO);
    }
    ...
    public void insertRequestOffer(RequestOfferVO RequestOfferVO) throws Exception {
    	if(RequestOfferVO.getCmd().equals("save")){
    		...
    		int nSeq = (Integer)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferReplySeq", RequestOfferVO);
    		
    		Map mapAnsParents = (Map)getSqlMapClientTemplate().queryForObject("RequestOffer.selectRequestOfferReplyaAnsParents", RequestOfferVO);
