...
<body onload="GLNB_Select(2,6,0)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 지구관리 &gt; 지구임원선임 &gt; <span>임원선임/분담금</span></p>
		</div>


<h3><div>임원선임/분담금 </div></h3>
<div class="table">
...
<h4>임원선임 및 분담금 입력</h4>
	<div class="btnBox">
		...
		<input type="image" src="/images/lionsclubs/btn/btn_excel.gif" alt="엑셀올리기" style="width:91px" />
		<input type="image" src="/images/lionsclubs/btn/btn_person.gif" alt="개인발령적용" style="width:103px" />
	</div>
