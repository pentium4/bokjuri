...
<body onload="GLNB_Select(2,3,3)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 지구관리 &gt; 제의무금 부과 &gt; <span>클럽별 부과금 조회</span></p>
		</div>


<h3><div>클럽별 부과금 조회 </div></h3>
<div class="table">
	<table class="tblType1" summary="클럽별 부과금 조회표">
	<caption>클럽별 부과금 조회</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
...
<h4>클럽별 부과금 조회</h4>
	...
	<tr>
		...
		<td class="right"></td>
		<td class="right">4,456,000</td>
		<td class="right">500,000</td>
		<td class="right"></td>
		<td class="right"></td>
		<td class="right">2,741,000</td>
		<td class="right">504,000</td>
		<td class="right"></td>
		<td class="right">8,235,000</td>
		<td class="right">504,000</td>
	</tr>
	<tr>
		<td>2</td>
	...
	<tr>
		<th colspan="2">합 계</th>
		<th class="right f11">32,758,000</th>
		<th class="right f11">65,580,000</th>
		<th class="right f11">4,565,000</th>
		<th class="right f11">51,120,000</th>
		<th class="right f11">32,759,000</th>
		<th class="right f11">34,450,750</th>
		<th class="right f11">26,884,555</th>
		<th class="right f11">170,000</th>
		<th class="right f11">115,884,555</th>
		<th class="right f11">76,170,000</th>
	</tr>
	</tbody>
	</table>
				</div><!-- Height_1 -->
