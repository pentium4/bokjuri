...
<body onload="GLNB_Select(2,0,3)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 지구관리 &gt; 기본 및 조회업무 &gt; <span>지구기본사항입력</span></p>
		</div>


<h3><div>회장/지구임원 조회 </div></h3>
<div class="table">
	...
	<tr>
		<th>지구코드</th>
		<td>K26-067 355-D(울산,양산)지구</td>
		<th rowspan="2">조회구분</th>
		<td rowspan="2" class="LH">
			<label for="s1">클럽순</label><input type="checkbox" id="s1" name="" value="" /> 클럽순&nbsp;&nbsp;
			<label for="s2">직책순</label><input type="checkbox" id="s2" name="" value="" /> 직책순
			<label for="s3">클럽임원순</label><input type="checkbox" id="s3" name="" value="" style="margin-left:38px;" /> 클럽임원순&nbsp;&nbsp;
			<label for="s4">퇴직제외</label><input type="checkbox" id="s4" name="" value="" /> 퇴직제외<br />
			<label for="s5">성명순</label><input type="checkbox" id="s5" name="" value="" /> 성명순&nbsp;&nbsp;
			<label for="s6">입회일자순</label><input type="checkbox" id="s6" name="" value="" /> 입회일자순&nbsp;&nbsp;
			<label for="s7">회원번호</label><input type="checkbox" id="s7" name="" value="" /> 회원번호
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
		<td><a href="/"><img src="/images/lionsclubs/sub/icon_pre.gif" alt="이전 년도" /></a>
			...
			<div class="arrowL"><a href="/" title="이전 페이지"><img src="/images/lionsclubs/sub/icon_pre2.gif" alt="전" /></a> <a href="/" title="다음 페이지"><img src="/images/lionsclubs/sub/icon_next2.gif" alt="후" /></a></div>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="table">
	...
	<tr>
		...
		<td class="Bbg"><a href="../include/mm2_7profile.html" onclick="window.open(this.href,'popup','width=500,height=210'); return false;" title="새창">홍길동</a></td>
		<td>2011.08.01</td>
		<td>2013-2014</td>
		<td class="left">제도개선법제위원장</td>
		<td class="left">010-1111-2222</td>
	</tr>
	<tr>
		<td>2</td>
		<td class="left">울산클럽</td>
