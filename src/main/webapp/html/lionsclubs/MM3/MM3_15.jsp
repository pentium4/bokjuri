...
<h3><div>연령별 퇴회현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="연령별 퇴회현황표">
	<caption>연령별 퇴회현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
...
<div class="tblTitle mT5 Scroll_Title">
	<table class="tblType2" summary="입회경력퇴회현황 조회표">
