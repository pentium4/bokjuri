...
<h4>클럽 및 지구행사 입력</h4>
	<div class="btnBox">
		<a href="../include/mm3_6popup.html" onclick="window.open(this.href,'popup','width=700,height=550'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
		<a href="../include/mm3_6popup2.html" onclick="window.open(this.href,'popup','width=700,height=550'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" /></a>
