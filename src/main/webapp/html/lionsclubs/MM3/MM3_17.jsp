...
<h3><div>회기년도 퇴회현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="회기년도 퇴회현황표">
	<caption>회기년도 퇴회현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
	...
	<tr>
		...
		<th>조회선택</th>
		<td><label for="s1">지구조회</label><input type="checkbox" id="s1" name="" value="" /> 지구조회&nbsp;&nbsp;
...
<div class="tblTitle mT5 Scroll_Title">
	<table class="tblType2" summary="클럽별퇴회현황 조회표">
	<caption>클럽별퇴회현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="100px" />
		<col width="100px" />
