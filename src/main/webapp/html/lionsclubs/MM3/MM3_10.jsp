...
<body onload="GLNB_Select(2,2,1)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 지구관리 &gt; 현황조회 &gt; <span>지구기본사항입력</span></p>
		</div>


<h3><div>클럽회기별 인원현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="클럽회기별 인원현황표">
	<caption>클럽회기별 인원현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
...
<div class="tblTitle mT5 Scroll_Title">
	<table class="tblType2" summary="클럽회기별인원현황 조회표">
	...
	<tr>
		<th colspan="3">계</th>
		<th class="right">1,360</th>
		<th class="right">1,430</th>
		<th class="right">1,525</th>
		<th class="right">1,568</th>
		<th class="right">2,595</th>
		<th class="right">1,660</th>
		<th class="right">1,660</th>
	</tr>
	</tbody>
	</table>
