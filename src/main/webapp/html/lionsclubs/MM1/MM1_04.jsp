...
<h4>경력사항</h4>
	<div class="btnBox">
		<a href="../include/mm1_4popup.html" onclick="window.open(this.href,'popup','width=500,height=250'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
		<a href="../include/mm1_4popup2.html" onclick="window.open(this.href,'popup','width=500,height=250'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" />
	...
	<tbody>
	<tr>
		<td class="center">2010.06.23~2010.06.30</td>
		<td class="center">지구</td>
		<td class="center">교육</td>
		<td>신입회원 연수교육</td>
		<td>지구회관</td>
	</tr>
	<tr>
