...
<body onload="GLNB_Select(1,0,4)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 개인기록관리 &gt; 입력 및 조회업무 &gt; <span>클럽포상 입력/조회</span></p> 
		</div>


<h3><div>클럽포상 입력/조회 </div></h3>
<div class="table">
	...
	<tr>
		...
		<td rowspan="2" class="LH">
			<label for="s1">회원번호</label><input type="checkbox" id="s1" name="" value="" /> 포상일자&nbsp;&nbsp;
			<label for="s2">직책순</label><input type="checkbox" id="s2" name="" value="" /> 포상구분&nbsp;&nbsp;
			<label for="s3">현회원</label><input type="checkbox" id="s3" name="" value="" /> 포상 수여자
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
...
<h4>클럽포상 입력/조회</h4>
	<div class="btnBox">
		<a href="../include/mm2_5popup.html" onclick="window.open(this.href,'popup','width=500,height=250'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
		<a href="../include/mm2_5popup2.html" onclick="window.open(this.href,'popup','width=500,height=250'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" /></a>
...
<div class="tblTitle Scroll_Title">
	...
	<tr>
		<td>2013.04.04</td>
		<td class="left">연합회</td>
		<td class="left">라이온스협회장</td>
		<td class="left">지구총재상</td>
		<td class="left">감사패</td>
	</tr>
	<tr>
		<td>2013.04.04</td>
		<td class="left">연합회</td>
