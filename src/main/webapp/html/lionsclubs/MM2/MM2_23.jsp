...
<body onload="GLNB_Select(1,2,4)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 개인기록관리 &gt; 예산편성 및 실적조회 &gt; <span>지출예산 실적조회</span></p> 
		</div>


<h3><div>지출예산 실적조회 </div></h3>
<div class="table">
	<table class="tblType1" summary="지출예산 실적조회표">
	<caption>지출예산 실적조회</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
	...
	<tr>
		...
		<td rowspan="2" class="LH">
			<label for="s1">지출분류항목별</label><input type="checkbox" id="s1" name="" value="" /> 지출분류항목별&nbsp;&nbsp;
			<label for="s2">지출세부항목별</label><input type="checkbox" id="s2" name="" value="" /> 지출세부항목별
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
...
<div class="tblTitle Scroll_Title">
	<table class="tblType2_1" summary="지출예산 및 결산현황 안내표">
