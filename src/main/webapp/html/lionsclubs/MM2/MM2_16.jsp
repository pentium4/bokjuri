...
<body onload="GLNB_Select(1,1,5)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 개인기록관리 &gt; 수입 및 지출 &gt; <span>예금현황</span></p> 
		</div>


<h3><div>예금현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="예금현황표">
	<caption>예금현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
	...
	<tr>
		...
		<td rowspan="2" class="LH">
			<label for="s1">회원번호</label><input type="checkbox" id="s1" name="" value="" /> 예금구분
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
...
<h4>예금현황</h4>
	<div class="btnBox">
		<a href="../include/mm2_16popup.html" onclick="window.open(this.href,'popup','width=500,height=300'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
		<a href="../include/mm2_16popup2.html" onclick="window.open(this.href,'popup','width=500,height=300'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" /></a>
		<input type="image" src="/images/lionsclubs/btn/btn_del.gif" alt="삭제" style="width:57px" />
	</div>

<div class="tblTitle Scroll_Title">
	<table class="tblType2_1" summary="클럽 예금 현황 안내표">
	<caption>클럽 예금 현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="200px" />
		<col width="120px" />
	...
	<tr>
		<td>보통예금</td>
		<td>2012.08.01~2013.08.10</td>
		<td class="right">15,000,000</td>
		<td class="right">15,000,000</td>
		<td class="left">국민은행 달동지점</td>
		<td class="left">홍길동과 초대회장</td>
	</tr>
	<tr>
		<td>보통예금</td>
		<td>2012.08.01~2013.08.10</td>
	...
	<tr>
		<th colspan="2">합 계</th>
		<th class="right">155,500,000</th>
		<th class="right">155,000,000</th>
		<th></th>
		<th></th>
	</tr>
	</tbody>
