...
<body onload="GLNB_Select(1,4,0)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 개인기록관리 &gt; 행사입력 및 조회 &gt; <span>클럽/지구행사 입력</span></p> 
		</div>
...
<div class="table">
	...
	<tr>
		<th>클럽코드</th>
		<td><div class="fL">K26-067 원클럽</div>
			<div class="fR mr20">
		...
		<td rowspan="2" class="LH">
			...
			<label for="s3">행사명</label><input type="checkbox" id="s3" name="" value="" /> 행사명
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
...
<h4>클럽 및 지구행사 입력</h4>
	<div class="btnBox">
		<a href="../include/mm2_29popup.html" onclick="window.open(this.href,'popup','width=700,height=550'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
		<a href="../include/mm2_29popup2.html" onclick="window.open(this.href,'popup','width=700,height=550'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" /></a>
