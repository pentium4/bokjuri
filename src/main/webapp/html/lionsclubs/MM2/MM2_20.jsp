...
<body onload="GLNB_Select(1,2,1)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 개인기록관리 &gt; 예산편성 및 실적조회 &gt; <span>연간 지출예산 입력</span></p> 
		</div>


<h3><div>연간 지출예산 입력 </div></h3>
<div class="table">
	<table class="tblType1" summary="연간 지출예산 입력표">
	<caption>연간 지출예산 입력</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
	...
	<tr>
		...
		<td rowspan="2" class="LH">
			<label for="s1">회원번호</label><input type="checkbox" id="s1" name="" value="" /> 지출분류항목별&nbsp;&nbsp;
			<label for="s3">현회원</label><input type="checkbox" id="s3" name="" value="" /> 분류항목별 산출근거<br />
			<label for="s3">현회원</label><input type="checkbox" id="s3" name="" value="" /> 지출세부항목별
		</td>
	</tr>
	<tr>
		<th>회기선택</th>
...
<div class="tblTitle Scroll_Title">
	<table class="tblType2_1" summary="지출예산 산출근거 안내표">
	...
	<tr>
		...
		<td class="left">식대</td>
		<td class="left">이사회(10회 x 10 x 10,000원)</td>
	...
	<tr>
		<td class="left"></td>
		<td class="left"></td>
		<td class="left">이사회(10회 x 25 x 12,000원)</td>
