...
<div class="table">
	...
	<tr>
		...
		<th>구&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;분</th>
		<td><div class="fL">평생회원</div>
			<!-- <div class="fR">
				<a href="../include/mm1_profile.html" onclick="window.open(this.href,'popup','width=700,height=300'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_input.gif" alt="입력" style="width:57px" /></a>
				<a href="../include/mm1_profile2.html" onclick="window.open(this.href,'popup','width=700,height=300'); return false;" title="새창"><input type="image" src="/images/lionsclubs/btn/btn_edit.gif" alt="수정" style="width:57px" /></a>
			</div> -->
		</td>
	...
	<tr>
		...
		<td>
			<div class="fL">
				<a href="../include/mm1_1popup2.html" onclick="window.open(this.href,'popup','width=1000,height=370'); return false;" title="새창"><strong>홍길동</strong></a>
			</div>
