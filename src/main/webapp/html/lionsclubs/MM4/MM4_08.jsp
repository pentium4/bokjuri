...
<body onload="GLNB_Select(3,1,3)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 복합/연합회 &gt; 현황조회 &gt; <span>회원연령구성현황</span></p>
		</div>


<h3><div>회원연령구성현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="회원연령구성현황표">
...
<div class="table">
	...
	<table class="tblType2_1" summary="회원연령구성현황표">
	<caption>회원연령구성현황</caption>
	<colgroup>
		<col width="50px" />
		<col width="*" />
	...
	<tr>
		...
		<td>1965.10.01</td>
		<td class="right">7,069</td>
		<td class="right">875</td>
		<td class="right">1,065</td>
		<td class="right">1,356</td>
		<td class="right">1,536</td>
