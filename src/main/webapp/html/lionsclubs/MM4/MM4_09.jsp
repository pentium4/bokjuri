...
<body onload="GLNB_Select(3,1,4)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 복합/연합회 &gt; 현황조회 &gt; <span>지역봉사사업현황</span></p>
		</div>


<h3><div>지역봉사사업현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="지역봉사사업현황표">
...
<div class="table">
	...
	<table class="tblType2_1" summary="지역봉사사업현황표">
	<caption>지역봉사사업현황</caption>
	<colgroup>
		<col width="50px" />
		<col width="*" />
	...
	<tr>
		...
		<td class="right">1,957,069</td>
		<td class="right">250,400</td>
		<td class="right">8,603,000</td>
		<td class="right">361,256,000</td>
		<td class="right">12,300,000</td>
		<td class="right">387,333,000</td>
	</tr>
	<tr>
		<td>2</td>
