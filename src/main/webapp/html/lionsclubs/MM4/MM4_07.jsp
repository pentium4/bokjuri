...
<body onload="GLNB_Select(3,1,2)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 복합/연합회 &gt; 현황조회 &gt; <span>회원입회경력현황</span></p>
		</div>


<h3><div>회원입회경력현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="회원입회경력현황표">
	...
	<tr>
		...
		<th>조회선택</th>
		<td>
			<label for="s1">연합회</label><input type="checkbox" id="s1" name="" value="" /> 연합회&nbsp;&nbsp;
			<label for="s2">지구조회</label><input type="checkbox" id="s1" name="" value="" /> 지구조회&nbsp;&nbsp;
			<label for="s2">클럽조회</label><input type="checkbox" id="s1" name="" value="" /> 클럽조회</td>
	</tr>
	<tr>
		<th>회기선택</th>
