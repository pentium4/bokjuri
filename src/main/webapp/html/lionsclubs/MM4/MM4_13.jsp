...
<body onload="GLNB_Select(3,1,8)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 복합/연합회 &gt; 현황조회 &gt; <span>회기회기별퇴회현황</span></p>
		</div>


<h3><div>회기회기별퇴회현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="회기회기별퇴회현황표">
	<caption>회기회기별퇴회현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
...
<div class="table">
	...
	<table class="tblType2_1" summary="회기회기별퇴회현황표">
	<caption>회기회기별퇴회현황</caption>
	<colgroup>
		<col width="*" />
		<col width="90px" />
