...
<body onload="GLNB_Select(3,1,6)">
	...
	<div id="Wrap">
		...
		<div id="position">
			...
			<p>HOME &gt; 복합/연합회 &gt; 현황조회 &gt; <span>LCIF기금납부자현황</span></p>
		</div>


<h3><div>LCIF기금납부자현황 </div></h3>
<div class="table">
	<table class="tblType1" summary="LCIF기금납부자현황표">
	<caption>LCIF기금납부자현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
		<col width="100px" />
...
<div class="table">
	...
	<table class="tblType2_1" summary="LCIF기금납부자현황표">
	<caption>LCIF기금납부자현황</caption>
	<colgroup>
		<col width="50px" />
		<col width="*" />
