...
(function($, undefined) {
  ...
  var events = {
    ...
    */
    ...
    $(document).on('deck.beforeInit', function(event) {
    ...
    */
    ...
    $d.on('deck.init', function() {
       $d.on('keydown.deck', function(event) {
  ...
  var bindKeyEvents = function() {
    ...
    $document.unbind('keydown.deck').on('keydown.deck', function(event) {
  ...
  var bindTouchEvents = function() {
    ...
    $container.on('touchstart.deck', function(event) {
      if (!startTouch) {
    ...
    $container.on('touchmove.deck', function(event) {
    ...
    $container.on('touchend.deck', function(event) {
      $.each(event.originalEvent.changedTouches, function(i, touch) {
        if (startTouch && touch.identifier === startTouch.identifier) {
          startTouch = undefined;
        }
  ...
  */
  ...
  $window.on('hashchange.deck', function(event) {
