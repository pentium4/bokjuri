...
(function($, undefined) {
  ...
  var bindKeyEvents = function() {
    ...
    $document.on('keydown.deckmenu', function(event) {
  ...
  var bindTouchEvents = function() {
    ...
    $container.on('touchstart.deckmenu', function() {
      currentSlide = $.deck('getSlide');
    });
    $container.unbind('touchend.deckmenu');
    $container.on('touchend.deckmenu', function(event) {
      var now = Date.now();
  ...
  var setupMenuSlideSelection = function() {
    ...
    $.each($.deck('getSlides'), function(i, $slide) {
      ...
      $slide.on('click.deckmenu', function(event) {
