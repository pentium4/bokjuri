...
<form:form modelAttribute="MM2_18VO" action="/m/MM6/MM6_1/MM6_08/listServiceMember.do" data-ajax="false">
<div id="content">
		...
		<table class="tblType2">
			...
			<tbody>
				...
				<tr>
					...
					<th>총계</th>
					<th class="right"><fmt:formatNumber value="${colTotSum}" pattern="#,###"/></th>
					<c:forEach items="${headList}" var="list" varStatus="status">
						<td class="right">
