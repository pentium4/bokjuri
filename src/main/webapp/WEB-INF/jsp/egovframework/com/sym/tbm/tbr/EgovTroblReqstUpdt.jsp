...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="장애신청 정보를 수정한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애ID<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애명<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애종류<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애설명<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애발생시간<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>장애등록자<img src="/images/egovframework/com/sym/tbm/tbr/icon/required.gif" width="15" height="15" alt=""></th>
