...
<table border="0">
  <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="네트워크 정보를 등록한다.">
      ...
      <!--
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>네트워크ID<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
       ...
       -->
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>IP<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>게이트웨이<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>서브넷<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>DNS<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>관리항목<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt="" /></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>사용자명<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt="" /></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>사용여부<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>등록일자<img src="/images/egovframework/com/sym/sym/nwk/icon/required.gif" width="15" height="15" alt=""></th>
