		...
		*/
		...
		$("#button_save").on("click", function(){
			...
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM2/MM2_3/MM2_20/duplicateCheck.do" />',
				data: params,
				dataType: 'json',
				success: function(data) {
					if(data.result == "Y") {
						dupliYn = "Y";
						alert('연간지출예산이 이미 존재합니다.');
						return false;
					}
				},
			...
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM2/MM2_3/MM2_20/otherIncomeInsert.do" />',
				data: params,
				dataType: 'json',
				success: function(data) {
...
function setCombo(key) {
	...
	params.push({name: "groupCode", value: "6000"});
...
<form:form id="form_insert" modelAttribute="MM2_20VO" >
	<h3 style="width:98%;"><div>연간지출예산 추가</div></h3>
