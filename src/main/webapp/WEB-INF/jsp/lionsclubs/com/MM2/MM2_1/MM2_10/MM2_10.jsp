					...
					<div>
						<span>
							<p class="photo" style="width: 100px; height: 120px;">
								<img data-original="${ctx}/jfile/thumbPreview.do?fileId=${list.memberPictureFile}" height="120px" width="100px" />
							</p>
							<span class="member">
						...
						<span>
							<p class="photo" style="width: 100px; height: 120px;">
								<img data-original="${ctx}/jfile/thumbPreview.do?fileId=${list.nessPictureFile}" height="120px" width="100px" />
							</p>
							<p class="txt ellipsis">
								<fmt:parseDate var="startDate" value="${list.startDate }" pattern="yyyyMMdd" />
								<c:choose>
									<c:when test="${not empty list.retireDate }">
										<strong class="Blue">${list.nessName }</strong>
									</c:when>
									<c:otherwise>${list.nessName }</c:otherwise>
								</c:choose>
							</p>
						</span>
					</div>
