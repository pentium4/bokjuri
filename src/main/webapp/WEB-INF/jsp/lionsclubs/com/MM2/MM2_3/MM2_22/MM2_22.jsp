...
<form:form id="form_list" modelAttribute="MM2_22VO">
	<h3><div><lions:menutitle menuId="${param.menuId }" kind="title" /></div></h3>
	<div class="table">
		<table class="tblType1" summary="수입예산 실적 조회표">
			<caption>수입예산 실적 조회</caption>
			<colgroup>
				<col width="100px" />
				<col width="380px" />
				<col width="100px" />
			...
			<tbody>
				<tr>
					...
					<td rowspan="2" class="LH">
						<form:checkbox path="s1" value="1" label="수입세부항목별" cssClass="ml10" /><br/>
	...
	<div class="table">
		...
		<div class="tblTitle Scroll_Title Height_0">
			<table class="tblType2_1" summary="수입예산실적 조회 안내표">
				...
				<tbody>
					<c:forEach items="${dataList}" var="list" varStatus="status">
						...
						<c:choose>
							...
							<c:when test="${list.classItemCode eq '1100' and (list.detailItemCode eq '1000' or list.detailItemCode eq '1010')}">
		...
		<div class="Scroll_Title Height_0">
			<table class="tblType2_1" summary="수입예산실적 조회 안내표 총계">
				<caption>수입예산 및 결산현황 총계</caption>
				<colgroup>
					<col width="150px" />
					<col width="*" />
					<col width="150px" />
