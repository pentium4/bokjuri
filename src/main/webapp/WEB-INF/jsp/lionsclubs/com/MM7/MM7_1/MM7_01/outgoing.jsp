...
require(['init'], function () {
	$(document).ready(function () {
		...
		$(".docTitle").on("click", function(){
			var data = $(this).data();
			openPopup('<c:url value="/MM7/MM7_1/MM7_01/docOutgoingDetailPopup.do?idnNo=' + data.idnno + '" />', 1000, 750, 'docPopup');
		});
		...
		$("#receiveOrganCode").organCode({
			...
			,top: true
			,auth: false
			,fixVal: "${MM7_01VO.receiveOrganCode}"
		});
		...
		<table class="tblType1">
			...
			<tbody>
				<tr>
					...
					<th>수신조직</th>
					<td><form:select path="receiveOrganCode" /></td>
				</tr>
				<tr>					
					<th>문서제목</th>
