...
require(['init'], function () {
	$(document).ready(function () {
		...
		$("#btnInput").on("click", function(){
			openPopup('<c:url value="/MM1/MM1_3/MM1_17/reinductPopup.do?organCode=${MM1_17VO.organCode}" />', 800, 550, 'reinductPopup');
		});
		...
		*/
		...
		$("#btnDelete").on("click", function(){
			...
			$(".idnNo:checked").each(function(index){
				var idnNo = $(this);
				params.push({name: "reinductMemberArray["+index+"].idnNo", value:idnNo.val()});
			});
			
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM1/MM1_3/MM1_17/deleteReinductMember.do" />',
				data: params,
				dataType: 'json',
		...
		$(".approve").on("click", function(){
			...
			$.ajax({
				url:  '<c:url value="/MM1/MM1_3/MM1_17/updateApprove.do" />',
				data: params,
				dataType: 'json',
				success: function(data) {
					if(data.result == "1"){
		...
		$(".approveCancel").on("click", function(){
			...
			$.ajax({
				url:  '<c:url value="/MM1/MM1_3/MM1_17/updateApproveCancel.do" />',
				data: params,
				dataType: 'json',
				success: function(data) {
					if(data.result == "1"){
...
<form:form modelAttribute="MM1_17VO">
	...
	<div class="table">
		...
		<div class="tblTitle Scroll_Title Height_0">
			<table class="tblType2_1" summary="전입회원 입력">
				<caption>전입회원 입력</caption>
				<colgroup>
					<col width="30px" />
					<col width="50px" />
					<col width="*" />
