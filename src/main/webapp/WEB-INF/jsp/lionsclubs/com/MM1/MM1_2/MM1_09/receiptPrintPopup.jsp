...
<form:form id="form" modelAttribute="MM1_09VO">
	<h3 class="h3"><div>영수증 출력</div></h3>
									...
									<table width="100%"  border="0" cellpadding="0" cellspacing="1">
										...
										<tdoby>
											...
											<tr>
												...
												<td colspan="2" valign="bottom" style="font-size: 24px;"><span style="margin-left: 20px;" />${fn:replace(fn:substring(result.organCode, 3, 4), '0', '') }${fn:substring(result.organCode, 4, 6) }. ${result.organName }<span style="margin-left: 10px;" />${result.name } 귀하 </td>
											</tr>
											<tr>
												<td height="34">&nbsp;</td>
												<td valign="top"><hr></td>
											...
											<tr>
												<td height="34" colspan="2">
													<span style="font-size: 24px; font-weight: bold;">${treasurer.districtName }</span>
												</td>
											</tr>
											<tr>
												<td height="40">
