	...
	$(document).ready(function () {
		...
		$("#button_edit").click(function() {
			...
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM1/MM1_1/MM1_02/MM1_02_Update.do" />',
				data: params,
				dataType: 'json',
...
<h3 style="width:98%;"><div>기념일 수정</div></h3>
...
<div class="popupBtn">
	<img id="button_edit" src="/images/lionsclubs/btn/btn_edit.gif" title="수정" style="width:57px" class="pointer" />
