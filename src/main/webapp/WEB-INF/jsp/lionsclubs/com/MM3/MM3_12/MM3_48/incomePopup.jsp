	...
	$(document).ready(function () {
		...
		$("#classItemCode").on("change", function(){
			$("#detailItemCode").option1Code({ 
		    	 groupCode: "6600"	// 그룹코드
		    	,code: $(this).val()	// 코드
		    	,fixVal: "${MM3_48VO.detailItemCode}"	// 고정값
		...
		$("#btnSave").on("click", function(){
			...
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM3/MM3_12/MM3_48/saveIncome.do" />',
				data: params,
				dataType: 'json',
...
<form:form modelAttribute="MM3_48VO" action="/MM3/MM3_12/MM3_48/incomePopup.do">
	<double-submit:preventer tokenKey="income" />
	...
	<div class="popup_bg">
		<table class="tblType2">
			...
			<tbody>
				<tr>
					<th>수입일자<span class="require">*</span></th>
					<td>
						<form:input path="incomeDate" cssClass="input date required" caption="수입일자" />
					</td>
				</tr>
				<tr>
					<th>분류항목<span style="margin-right: 10px;" /></th>
					<td>기타수입</td>
				</tr>
				<tr>
					<th>세부항목<span class="require">*</span></th>
					<td>
						<lions:codeselect groupCode="7160" path="detailItemCode" class="select required" caption="세부항목" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>수입내용<span class="require">*</span></th>
					<td>
						<form:textarea path="desc" cssClass="textarea required" cols="43" rows="10" maxlength="4000" caption="수입내용" />
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="popupBtn">
		<c:choose>
			<c:when test="${not empty MM3_48VO.idnNo }">
