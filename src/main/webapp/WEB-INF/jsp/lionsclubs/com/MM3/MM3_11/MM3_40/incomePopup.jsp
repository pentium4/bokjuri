	...
	$(document).ready(function () {
		...
		$("#classItemCode").on("change", function(){
			$("#detailItemCode").option1Code({ 
		    	 groupCode: "7000"	// 그룹코드
		    	,code: $(this).val()	// 코드
		    	,fixVal: "${MM3_40VO.detailItemCode}"	// 고정값
		...
		$("#btnSave").on("click", function(){
			...
			$.ajax({
				type: "POST",
				async: false,
				url:  '<c:url value="/MM3/MM3_11/MM3_40/saveIncome.do" />',
				data: params,
				dataType: 'json',
...
<form:form modelAttribute="MM3_40VO" action="/MM3/MM3_11/MM3_40/incomePopup.do">
	<double-submit:preventer tokenKey="income" />
	
	<h3><div>연간수입예산</div></h3>
	<div class="popup_bg">
		<table class="tblType2">
			...
			<tbody>
				<tr>
					...
					<td>
						<lions:codeselect groupCode="7000" path="classItemCode" class="select required" caption="분류항목" />
					</td>
				</tr>
				<tr>
	...
	<div class="popupBtn">
		<c:choose>
			<c:when test="${not empty MM3_40VO.idnNo }">
