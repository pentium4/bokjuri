...
require(['init'], function () {
	$(document).ready(function () {
		...
		$("#orgCode").organCode({
			...
			,fixVal:"${MM3_15VO.orgCode}"
		});
		
		$("#thisYear").sessionYearCombo({
			 fixVal: "${MM3_15VO.thisYear}"  // 고정값
			,top:false
		});
...
<form:form id="form_list" modelAttribute="MM3_15VO">
<h3><div><lions:menutitle menuId="${param.menuId }" kind="title" /></div></h3>
	...
	<div class="table" style="margin-bottom:15px !important;">
		...
		<div class="tblTitle Height_0 Scroll_Title widthLong" style="overflow-x: hidden;"> 
			<table class="tblType2_1" summary="연령별퇴회현황표" style="margin-bottom:1px;">
				<caption>연령별퇴회현황표</caption>
				<colgroup>
					<col width="50px" />
					<col width="120" />
					<col width="100px" />
			...
			<table class="tblType2_1 Scroll_Table" id="listTable">
				...
				<tbody> 
					...
					<c:forEach items="${resultList}" var="list" varStatus="status">
						<tr>
							<td>${status.count} </td>
							<td class="left"><c:out value="${list.ageName }" /></td>
