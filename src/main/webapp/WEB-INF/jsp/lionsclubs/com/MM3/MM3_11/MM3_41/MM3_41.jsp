...
require(['init'], function () {
	$(document).ready(function () {
		...
		$("#sessionYear").sessionYearCombo({
			 fixVal: "${MM3_41VO.sessionYear}"	// 고정값
			,top:false
		});
		...
		*/	
		...
		$("#btnInsert").on("click", function(){
			openPopup('/MM3/MM3_11/MM3_41/expendPopup.do?sessionYear=${MM3_41VO.sessionYear}&organCode=${MM3_41VO.organCode}', '500', '350', 'expendPopup');	
		});
		...
		$("#btnUpdate").on("click", function(){
			...
			openPopup('/MM3/MM3_11/MM3_41/expendPopup.do?idnNo=' + idnNo, '500', '350', 'expendPopup');	
		});
		...
		$("#btnDelete").on("click", function(){
			...
			$.ajax({
				type: "POST",
				async: true,			
				url:  '<c:url value="/MM3/MM3_11/MM3_41/deleteExpend.do" />',
				data: params,
				dataType: 'json',
		...
		$("#excelDownload").on("click", function(){
			$(window).unbind();
			$.download("/MM3/MM3_11/MM3_41/excelDownload.do", $("form").serialize());
		});
		
		$("#excelUpload").on("click", function(){
			openPopup("/MM3/MM3_11/MM3_41/excelUploadPopup.do?sessionYear=${MM3_41VO.sessionYear}&organCode=${MM3_41VO.organCode}", '600', '185', "excelUpload");
		});
	});
});
