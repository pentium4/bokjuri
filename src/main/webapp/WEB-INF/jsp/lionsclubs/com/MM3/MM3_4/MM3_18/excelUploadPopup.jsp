	...
	$(document).ready(function () {
		...
		$("#excelUpload").on("click", function(){
			if(submitCount == 0){
				...
				$("form").ajaxSubmit({
					 url: '<c:url value="/MM3/MM3_4/MM3_18/excelUpload.do" />'
					,type: "POST"
					,dataType: "html"
		...
		// 	 				alert('정상적으로 입력 되었습니다.');
							$("#districtCode", opener.document).val($("#districtCode").val());
							$("#sessionYear", opener.document).val($("#sessionYear").val());
							opener._search();
							closeWin();
						} else {
							alert(r.result);
...
<div style="width:100%; height:100%;">
	<form:form id="MM3_18VO" modelAttribute="MM3_18VO">
