...
require(['init'], function () {
	$(document).ready(function () {
		...
		$("#sessionYear").sessionYearCombo({
			 top: false
			,fixVal: "${MM3_59VO.sessionYear}"
		});
		
		$("#month").monthCombo({
			 top: false
			,fixVal: "${MM3_59VO.month}"
		});
		...
		$("#excelDownload").on("click", function(){
			...
			$(window).unbind();
			$.download("/MM3/MM3_10/MM3_59/excelDownload.do", $("form").serialize());
		});
	});
});
...
<form:form modelAttribute="MM3_59VO">
				...
				<tbody>
					<c:forEach items="${resultList }" var="list" varStatus="status">
						<tr>
							...
							<td class="center">${list.memberEngName }</td>
