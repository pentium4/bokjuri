...
<form:form id="form_list" modelAttribute="MM3_13VO">
<h3><div><lions:menutitle menuId="${param.menuId }" kind="title" /></div></h3>
<div class="table">
	<table class="tblType1" summary="클럽별 퇴회현황표">
	<caption>클럽별 퇴회현황</caption>
	<colgroup>
		<col width="100px" />
		<col width="*" />
	</colgroup>
...
<div class="table" style="margin-bottom:15px !important;">
	...
	<div class="tblTitle Height_0 Scroll_Title widthLong" style="overflow-x: hidden;">
		<table class="tblType2_1" summary="클럽별퇴회현황 조회표">
