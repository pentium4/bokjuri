...
require(['init'], function () {
	$(document).ready(function () {
		...
		$("#yearCode").sessionYearCombo({
			  fixVal: "${MM4_15VO_PARAM.yearCode}"  // 고정값
			  ,top:false
			 });
...
<form:form id="form_list"  modelAttribute="MM4_15VO_PARAM">
...
<div class="table">
	<div class="tblTitle Height_0 Scroll_Title widthLong" style="overflow-x: hidden;">
		<table class="tblType2 table-fixed" summary="연령별퇴회현황표">	
			...
			<thead>
				<tr>
					...
					<th class="ellipsis" title="연령">연령</th>
